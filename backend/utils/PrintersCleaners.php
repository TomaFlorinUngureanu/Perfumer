...
function printShoppingCart($fragranceArray)
{
    ...
    if($fragranceArray  != false)
    {
        ...
        {
            array_push($perfumeWrapperArray,
                "<button type=\"button\" class=\"updateQuantityButton\" onclick=\"updateQuantities()\">
                    Update Quantities</button><br><br><br> <input type=\"button\" class=\"button\" 
