function setUserAddress() {
    let userAddressElement = document.getElementById('inputDeliveryAddress');
    ...
    userAddress = userAddress.toString().replace(lt, "&lt;").replace(gt, "&gt;").replace(ap, "&#39;").replace(ic, "&#34;");
    ...
    let updateUserAddressElement = document.getElementById('userAddress');
